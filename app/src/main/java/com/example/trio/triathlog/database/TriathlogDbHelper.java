package com.example.trio.triathlog.database;
...
import com.example.trio.triathlog.model.ActivityContract;
import com.example.trio.triathlog.model.ActivitySummary;
import com.example.trio.triathlog.model.Profile;
import com.example.trio.triathlog.model.ProfileContract;
import com.example.trio.triathlog.model.Type;
import com.example.trio.triathlog.model.TypeContract;
...
public class TriathlogDbHelper extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 16;
    public static final String DATABASE_NAME = "Triathlog.db";
    public static TriathlogDbHelper instance;

    private TriathlogDbHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static TriathlogDbHelper getInstance(Context context){
        if (instance == null){
            return new TriathlogDbHelper(context);
        }
        return instance;
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertTypes(db);
        Profile profile = new Profile(1, null, 0,0,null,null,0,0);
    ...
    //PROFILE
    public long insertProfile(SQLiteDatabase db, Profile profile) {
        ContentValues values = new ContentValues();
    ...
    public void insertTypes(SQLiteDatabase db){
        ...
        List<Integer> type_icons = Arrays.asList(R.drawable.run,R.drawable.bike,R.drawable.swim);
